...
public class CardViewHeroAdapter extends RecyclerView.Adapter<CardViewHeroAdapter.CardViewViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CardViewHeroAdapter.CardViewViewHolder cardViewViewHolder, int position) {
        ...
        cardViewViewHolder.btnFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(cardViewViewHolder.itemView.getContext(), "Favorite " +
                        listHero.get(cardViewViewHolder.getAdapterPosition()).getName(), LENGTH_SHORT).show();
            }
        });
        ...
        cardViewViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(v.getContext(), "Kamu memilih " +
                        listHero.get(cardViewViewHolder.getAdapterPosition()).getName(), LENGTH_SHORT).show();
            }
        });
